...
<!-- 
 ...
 <%
	...
	// 총갯수 구하기
	int totalRow = (Integer)paymentList.get(0).get("totalRow");
		...
		<div id="paymentListTable">
			...
			%>
					<tr>
						...
						<td><a class="btn" id="paymentDetail" href="/atti/view/paymentDetail.jsp?regiNo=<%=(Integer)h.get("regiNo")%>">상세보기</a></td>
					</tr>
			<%
				}
			%>
