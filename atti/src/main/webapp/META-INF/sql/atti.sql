...
-- 테이블 데이터 atti.clinic:~32 rows (대략적) 내보내기
DELETE FROM `clinic`;
INSERT INTO `clinic` (`clinic_no`, `regi_no`, `clinic_content`, `clinic_cost`, `create_date`, `update_date`) VALUES
	...
	(48, 63, ' [2024-05-30 21:41] 진료시작\n [2024-05-30 21:41] 소변검사필요\n [2024-05-30 22:28] 수술 완료 경과 최고 좋음 eeeeee', 5000, '2024-05-30 21:41:02', '2024-05-30 21:41:02'),
	(49, 64, '[2024-05-30 21:47:40]진료시작\n [2024-05-30 21:48] 엑스레이 사진 촬영이 필요 \n [2024-05-30 22:48] 수술 때문에 미리 입원 필요 \n [2024-05-30 22:51] 고양이 손으로 잘못 올렸으니 수정하세요 ', 5000, '2024-05-30 21:47:40', '2024-05-30 21:47:40'),
	(50, 69, '[2024-05-30 22:45:10]진료시작', 5000, '2024-05-30 22:45:10', '2024-05-30 22:45:10'),
	(51, 67, '[2024-05-30 22:45:23]진료시작\n [2024-05-30 22:47] 등딱지 엑스레이 촬영이 필요 혹시몰라 혈액검사도 같이 진행', 5000, '2024-05-30 22:45:23', '2024-05-30 22:45:23'),
	(52, 65, '[2024-05-30 22:45:25]진료시작', 5000, '2024-05-30 22:45:25', '2024-05-30 22:45:25'),
	(53, 68, '[2024-05-30 22:45:30]진료시작\n [2024-05-30 22:46] 수술 전 엑스레이 촬영 필요', 5000, '2024-05-30 22:45:30', '2024-05-30 22:45:30'),
	(54, 66, '[2024-05-30 22:45:32]진료시작\n [2024-05-30 22:52] 날개 뼈 확인필요하므로 엑스레이 찍어주세요 ', 5000, '2024-05-30 22:45:32', '2024-05-30 22:45:32');
...
INSERT INTO `customer` (`customer_no`, `customer_name`, `customer_tel`, `customer_address`, `create_date`, `update_date`) VALUES
	...
	(26, '김바보', '01077777777', '계남로 ', '2024-05-30 20:25:24', '2024-05-30 20:25:24');
...
-- 테이블 데이터 atti.employee:~7 rows (대략적) 내보내기
...
INSERT INTO `employee` (`emp_no`, `emp_major`, `emp_grade`, `emp_name`, `emp_birth`, `emp_gender`, `emp_tel`, `hire_date`, `emp_pw`) VALUES
	...
	(3240530, '포유류', '간호사', '김호사', '2000-02-29', 'M', '01022222222', '2024-05-30', '*A4B6157319038724E3560894F7F932C8886EBFCF');
...
CREATE TABLE IF NOT EXISTS `examination` (
  ...
  `file_name` varchar(100) NOT NULL DEFAULT 'default.jpg',
...
-- 테이블 데이터 atti.examination:~19 rows (대략적) 내보내기
...
INSERT INTO `examination` (`examination_no`, `regi_no`, `examination_kind`, `examination_content`, `file_name`, `examination_date`) VALUES
	(4, 10, '소변검사', '소변 검사', 'default.jpg', '2024-05-14 07:47:00'),
	(5, 11, 'x-ray', '다리 관절 x-ray 촬영', 'default.jpg', '2024-05-14 08:47:00'),
	...
	(8, 15, 'x-ray', '종합 x-ray 촬영', 'default.jpg', '2024-05-14 12:47:00'),
	(9, 16, '혈액검사', '혈액 검사', 'default.jpg', '2024-05-14 12:47:00'),
	(10, 20, '혈액검사', '혈액 검사', 'default.jpg', '2024-05-09 14:59:37'),
	(11, 20, 'x-ray', '종합 x-ray 촬영', 'default.jpg', '2024-05-09 17:14:59'),
	(12, 21, '혈액검사', '혈액 검사', 'default.jpg', '2024-05-09 14:59:37'),
	(13, 25, '혈액검사', '혈액 검사', 'default.jpg', '2024-05-11 14:59:37'),
	(14, 26, '혈액검사', '혈액 검사', 'default.jpg', '2024-04-02 15:59:37'),
	(15, 30, '혈액검사', '혈액 검사', 'default.jpg', '2024-04-05 16:59:37'),
	(22, 63, 'x-ray', '검..사...', '815be95040534f93bea0e6fb99bd4a97.png', '2024-05-30 22:23:32'),
	(23, 68, 'x-ray', '', 'default.jpg', '2024-05-30 22:46:39'),
	(24, 67, 'x-ray', '촬영 완료 의사 진료필요', 'c4f06685c1fa489681d420d3cc16a207.jpeg', '2024-05-30 22:52:01'),
	(25, 67, '혈액검사', '', 'default.jpg', '2024-05-30 22:47:58'),
	(26, 64, 'x-ray', '너무 귀여워 고양이 손...', 'c4d65ff442dc4b218b5d05f3185b89d9.jpeg', '2024-05-30 22:50:54'),
	(27, 66, 'x-ray', '날개 수술필요할 것 같음 뼈가 부러져 있음 ', '9309abff4efe4c66b78f97863124726a.jpg', '2024-05-30 22:53:30'),
	(28, 66, 'x-ray', '날개부분만 찍어주세요', 'default.jpg', '2024-05-30 22:53:59');
...
-- 테이블 데이터 atti.hospitalization:~18 rows (대략적) 내보내기
...
INSERT INTO `hospitalization` (`hospitalization_no`, `room_name`, `regi_no`, `hospitalization_content`, `state`, `create_date`, `discharge_date`) VALUES
	...
	(3, 'C03', 12, '다리 골절 수술로 입원\n [2024-05-21 10:57 박임시] 골절수술 부위 체크완료 ', '퇴원', '2024-05-14 10:47:00', '2024-05-16 00:00:00'),
	...
	(16, 'A01', 5, '다리 수술 후 입원 중 입니다.  \r\n\n [2024-05-23 21:02 박임시] 다리 경과 좋음 \n [2024-05-30 17:23 박지유] 경과좋음 ', '퇴원', '2024-05-17 12:09:33', '2024-05-20 12:09:33'),
	(37, 'A07', 63, '\n [2024-05-30 22:31 박지유] 다리 수술 짱 좋음 \n [2024-05-30 22:31 박지유] 아쉽니 난 힘들다', '퇴원', '2024-05-30 22:30:14', '2024-06-02 22:30:14'),
	(38, 'C07', 68, '', '입원', '2024-05-30 22:45:54', '2024-06-02 22:45:54'),
	(39, 'C03', 66, '', '입원', '2024-05-30 22:47:01', '2024-06-02 22:47:01'),
	(40, 'B05', 67, '', '입원', '2024-05-30 22:48:06', '2024-06-02 22:48:06'),
	(41, 'A02', 64, '', '입원', '2024-05-30 22:49:10', '2024-06-02 22:49:10');
...
INSERT INTO `hospital_room` (`room_name`, `state`, `cost`, `update_date`) VALUES
	...
	('B05', 'ON', 150000, '2024-05-10 09:59:44'),
	...
	('C07', 'ON', 75000, '2024-05-10 09:59:44'),
...
-- 테이블 데이터 atti.payment:~91 rows (대략적) 내보내기
DELETE FROM `payment`;
INSERT INTO `payment` (`payment_no`, `regi_no`, `payment_state`, `payment_category`, `create_date`) VALUES
	(2, 3, '완납', '진료', '2024-05-09 16:59:37'),
	(3, 5, '완납', '진료', '2024-05-09 16:59:37'),
	(4, 3, '완납', '수술', '2024-05-09 17:29:35'),
	(5, 3, '완납', '처방', '2024-05-09 17:37:18'),
	(6, 3, '완납', '처방', '2024-05-09 17:38:08'),
	(8, 3, '완납', '검사', '2024-05-10 09:48:06'),
	(9, 4, '완납', '검사', '2024-05-10 09:48:06'),
	(10, 3, '완납', '입원', '2024-05-10 10:11:16'),
	(11, 10, '완납', '진료', '2024-05-14 10:47:00'),
	(12, 10, '완납', '검사', '2024-05-14 10:47:00'),
	(13, 11, '완납', '진료', '2024-05-14 10:47:00'),
	(14, 11, '완납', '검사', '2024-05-14 10:47:00'),
	(15, 11, '완납', '입원', '2024-05-14 10:47:00'),
	(16, 12, '완납', '진료', '2024-05-14 10:47:00'),
	(17, 12, '완납', '수술', '2024-05-14 10:47:00'),
	(18, 12, '완납', '입원', '2024-05-14 10:47:00'),
	(19, 13, '완납', '진료', '2024-05-14 10:47:00'),
	(20, 13, '완납', '처방', '2024-05-14 10:47:00'),
	(21, 14, '완납', '진료', '2024-05-14 10:47:00'),
	(22, 14, '완납', '입원', '2024-05-14 10:47:00'),
	(23, 15, '완납', '진료', '2024-05-28 17:44:43'),
	(24, 15, '완납', '검사', '2024-05-14 10:47:00'),
	(25, 15, '완납', '입원', '2024-05-28 17:47:21'),
	(26, 15, '완납', '수술', '2024-05-28 17:44:29'),
	(27, 15, '완납', '처방', '2024-05-28 16:20:34'),
	...
	(97, 63, '완납', '진료', '2024-05-30 21:41:02'),
	(98, 63, '완납', '처방', '2024-05-30 21:41:49'),
	(99, 64, '미납', '진료', '2024-05-30 21:47:40'),
	(100, 63, '완납', '검사', '2024-05-30 22:20:16'),
	(101, 63, '완납', '수술', '2024-05-30 22:27:13'),
	(102, 63, '완납', '입원', '2024-05-30 22:30:14'),
	(103, 69, '미납', '진료', '2024-05-30 22:45:10'),
	(104, 67, '미납', '진료', '2024-05-30 22:45:23'),
	(105, 65, '미납', '진료', '2024-05-30 22:45:25'),
	(106, 68, '미납', '진료', '2024-05-30 22:45:30'),
	(107, 66, '미납', '진료', '2024-05-30 22:45:32'),
	(108, 68, '미납', '입원', '2024-05-30 22:45:54'),
	(109, 68, '미납', '수술', '2024-05-30 22:46:25'),
	(110, 68, '미납', '검사', '2024-05-30 22:46:39'),
	(111, 66, '미납', '입원', '2024-05-30 22:47:01'),
	(112, 66, '미납', '처방', '2024-05-30 22:47:15'),
	(113, 67, '미납', '검사', '2024-05-30 22:47:58'),
	(114, 67, '미납', '입원', '2024-05-30 22:48:06'),
	(115, 64, '미납', '검사', '2024-05-30 22:48:47'),
	(116, 64, '미납', '입원', '2024-05-30 22:49:10'),
	(117, 64, '미납', '처방', '2024-05-31 00:53:31'),
	(118, 66, '미납', '검사', '2024-05-30 22:53:59'),
	(119, 66, '미납', '수술', '2024-05-30 22:54:53');
...
INSERT INTO `pet` (`pet_no`, `customer_no`, `emp_major`, `pet_kind`, `pet_name`, `pet_birth`, `create_date`, `update_date`) VALUES
	(1, 3, '조류', '까치', '왕눈이', '2024-05-08', '2024-05-09 16:26:55', '2024-05-09 16:26:55'),
	...
	(8, 10, '포유류', '고양이', '네엣', '2024-05-01', '2024-05-14 10:16:54', '2024-05-14 10:16:54'),
	...
	(12, 14, '조류', '앵무새', '여덟', '2024-05-01', '2024-05-14 10:16:54', '2024-05-14 10:16:54'),
	(13, 15, '파충류', '이구아나', '아홉', '2024-05-08', '2024-05-14 10:16:54', '2024-05-14 10:16:54'),
	...
	(17, 19, '파충류', '거북이', '열세엣', '2024-05-08', '2024-05-14 10:16:54', '2024-05-14 10:16:54'),
	...
	(20, 22, '포유류', '미어캣', '열여섯', '2024-05-01', '2024-05-14 10:16:54', '2024-05-14 10:16:54');
...
-- 테이블 데이터 atti.prescription:~15 rows (대략적) 내보내기
...
INSERT INTO `prescription` (`prescription_no`, `regi_no`, `medicine_no`, `prescription_content`, `prescription_date`) VALUES
	...
	(32, 63, 2, '처방이당', '2024-05-30 22:30:05'),
	(33, 66, 1, '진통제 처방 반알', '2024-05-30 22:47:15'),
	(34, 64, 3, '1/3만 쪼개서 처방', '2024-05-30 22:49:26'),
	(35, 64, 1, '1일 2회 반알씩 급여', '2024-05-31 00:54:03');
...
-- 테이블 데이터 atti.registration:~42 rows (대략적) 내보내기
DELETE FROM `registration`;
INSERT INTO `registration` (`regi_no`, `pet_no`, `emp_no`, `regi_content`, `create_date`, `regi_state`, `regi_date`) VALUES
	(2, 1, 1100802, '배변기능 이상', '2024-05-09 16:59:37', '완료', '2024-05-14 13:47:00'),
	(3, 2, 2020226, '다리 관절  이상', '2024-05-09 16:59:37', '완료', '2024-05-14 14:47:00'),
	(4, 3, 3200513, '시력  이상', '2024-05-09 16:59:37', '취소', '2024-05-24 10:00:00'),
	(5, 4, 3181112, '소화 기능  이상', '2024-05-09 16:59:37', '취소', '2024-05-14 15:47:00'),
	(6, 5, 1100802, '배변기능 이상', '2024-05-14 10:47:00', '취소', '2024-05-14 16:47:00'),
	(7, 6, 2020226, '다리 관절  이상', '2024-05-14 10:47:00', '취소', '2024-05-25 10:10:10'),
	(8, 7, 3200513, '시력  이상', '2024-05-14 10:47:00', '취소', '2024-05-20 11:11:11'),
	(9, 8, 3181112, '소화 기능  이상', '2024-05-14 10:47:00', '취소', '2024-05-26 09:00:00'),
	(10, 5, 2020226, '소화 기능 이상', '2024-05-14 10:47:00', '완료', '2024-05-14 07:47:00'),
	(11, 6, 1100802, '다리 관절  이상', '2024-05-14 10:47:00', '완료', '2024-05-14 08:47:00'),
	(12, 7, 2020227, '다리 관절 골절', '2024-05-14 10:47:00', '완료', '2024-05-14 09:47:00'),
	(13, 8, 1100802, '비틀비틀 걸어요', '2024-05-14 10:47:00', '완료', '2024-05-14 10:47:00'),
	(14, 9, 2020226, '눈에 이물질이 들어갔어요', '2024-05-14 10:47:00', '완료', '2024-05-14 11:47:00'),
	(15, 10, 1100802, '발작증상', '2024-05-14 10:47:00', '완료', '2024-05-14 12:47:00'),
	...
	(57, 20, 1100802, '미어캣이 안두리번거려요', '2024-05-30 20:29:57', '예약', '2024-05-31 09:00:00'),
	(58, 11, 1100802, '피부병 의심. 자꾸 긁음', '2024-05-30 20:34:43', '예약', '2024-05-31 01:00:00'),
	(59, 13, 2020226, '탈피를 못하고 있음', '2024-05-30 20:35:23', '예약', '2024-05-31 09:00:00'),
	(60, 9, 2020226, '다리가 찢어짐', '2024-05-30 20:36:28', '예약', '2024-05-31 01:00:00'),
	(61, 12, 2020227, '다리 부러진 것 같음', '2024-05-30 20:37:10', '예약', '2024-05-31 09:00:00'),
	(62, 1, 2020227, '은혜를 안갚음', '2024-05-30 20:38:36', '예약', '2024-05-31 01:00:00'),
	(63, 18, 1100802, '열네엣이가 토를 너무 자주 한대요', '2024-05-30 21:05:52', '완료', '2024-05-30 09:00:00'),
	(64, 15, 1100802, '다리를 절뚝이고 있어요', '2024-05-30 21:45:16', '진행', '2024-05-30 01:00:00'),
	(65, 5, 2020226, '삼일째 밥을 안먹고 있습니다', '2024-05-30 22:43:03', '진행', '2024-05-30 09:00:00'),
	(66, 14, 2020227, '날개부상', '2024-05-30 22:43:24', '진행', '2024-05-30 09:00:00'),
	(67, 17, 2020226, '거북이 등딱지가 벗겨졌음', '2024-05-30 22:43:48', '진행', '2024-05-30 01:00:00'),
	(68, 7, 2020227, '부리가 부러짐', '2024-05-30 22:44:06', '진행', '2024-05-30 01:00:00'),
	(69, 18, 1100802, '토를 너무 자주 한대요', '2024-05-30 22:44:50', '진행', '2024-05-30 01:00:00');
...
CREATE TABLE IF NOT EXISTS `surgery` (
  ...
  `surgery_state` enum('대기','완료') NOT NULL DEFAULT '대기',
...
-- 테이블 데이터 atti.surgery:~11 rows (대략적) 내보내기
DELETE FROM `surgery`;
INSERT INTO `surgery` (`surgery_no`, `regi_no`, `surgery_kind`, `surgery_content`, `surgery_date`, `surgery_state`) VALUES
	(2, 12, '외과', '골절로 인한 수술 진행 ', '2024-05-14 09:47:00', '완료'),
	(3, 15, '외과', '종양 발견 발견으로 수술 진행', '2024-05-14 12:47:00', '완료'),
	(4, 17, '외과', '골절로 인한 수술 진행 ', '2024-05-09 11:59:37', '완료'),
	(5, 20, '외과', '중성화수술', '2024-05-09 14:59:37', '완료'),
	(6, 22, '내과', '소화기관 수술', '2024-05-11 11:59:37', '완료'),
	(7, 25, '외과', '부리 접합 수술', '2024-05-11 14:59:37', '완료'),
	(8, 27, '외과', '골절로 인한 수술 진행 ', '2024-04-08 12:59:37', '완료'),
	(9, 30, '외과', '중성화수술', '2024-04-05 16:59:37', '완료'),
	(15, 63, '외과', '무어무어때문에 수술이 필요함 간호사 2명들어와햠', '2024-05-30 22:27:00', '완료'),
	(16, 68, '외과', '부리 접착 필요 ', '2024-05-31 22:46:00', '대기'),
	(17, 66, '외과', '날개 뼈 붙여...', '2024-05-30 22:54:00', '대기');
