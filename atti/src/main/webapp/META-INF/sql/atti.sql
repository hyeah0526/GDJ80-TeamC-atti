...
-- atti 데이터베이스 구조 내보내기
CREATE DATABASE IF NOT EXISTS `atti` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_german2_ci */;
USE `atti`;
...
CREATE TABLE IF NOT EXISTS `clinic` (
  ...
  `clinic_cost` int(11) NOT NULL DEFAULT 5000,
...
-- 테이블 데이터 atti.clinic:~27 rows (대략적) 내보내기
DELETE FROM `clinic`;
INSERT INTO `clinic` (`clinic_no`, `regi_no`, `clinic_content`, `clinic_cost`, `create_date`, `update_date`) VALUES
	(1, 2, '배변기능 이상으로 정밀 검사 필요. X-ray 및 혈액 검사 진행 후 재검진', 8000000, '2024-05-09 17:12:19', '2024-05-09 17:12:19'),
	...
	(36, 46, '진료등록 test', 5000, '2024-05-30 10:45:16', '2024-05-30 10:45:16'),
	(42, 45, '[2024-05-30 16:11:24] ㅂㅂ\n[2024-05-30 16:10:27] ㄷㄷ', 5000, '2024-05-30 16:04:59', '2024-05-30 16:11:24');
...
-- 테이블 데이터 atti.customer:~21 rows (대략적) 내보내기
...
INSERT INTO `customer` (`customer_no`, `customer_name`, `customer_tel`, `customer_address`, `create_date`, `update_date`) VALUES
	...
	(24, '김바보', '01022225555', '대한민국', '2024-05-29 17:14:52', '2024-05-29 17:14:52');
...
-- 테이블 데이터 atti.employee:~6 rows (대략적) 내보내기
DELETE FROM `employee`;
INSERT INTO `employee` (`emp_no`, `emp_major`, `emp_grade`, `emp_name`, `emp_birth`, `emp_gender`, `emp_tel`, `hire_date`, `emp_pw`) VALUES
	(1100802, '포유류', '관리자', '박지유', '1987-04-23', 'M', '01055555555', '2010-08-02', '*97E7471D816A37E38510728AEA47440F9C6E2585'),
	...
	(3200513, '포유류', '간호사', '강국길', '1996-12-03', 'M', '01066666666', '2020-05-13', '*A4B6157319038724E3560894F7F932C8886EBFCF'),
	(3240522, '파충류', '퇴사자', '김만족', '2024-05-10', 'F', '01077777777', '2024-05-22', '*A4B6157319038724E3560894F7F932C8886EBFCF');
...
INSERT INTO `examination` (`examination_no`, `regi_no`, `examination_kind`, `examination_content`, `file_name`, `examination_date`) VALUES
	(4, 10, '소변검사', '소변 검사', '', '2024-05-14 07:47:00'),
	(5, 11, 'x-ray', '다리 관절 x-ray 촬영', '', '2024-05-14 08:47:00'),
	(6, 15, '소변검사', '소변 검사', 'c67c03c87fbd4fa0b91238e9b2a22bc4.png', '2024-05-14 12:47:00'),
	(7, 15, '혈액검사', '혈액 검사', 'c67c03c87fbd4fa0b91238e9b2a22bc4.png', '2024-05-14 12:47:00'),
	...
	(20, 45, 'x-ray', 'te', '', '2024-05-30 10:47:25');
...
-- 테이블 데이터 atti.hospitalization:~13 rows (대략적) 내보내기
...
INSERT INTO `hospitalization` (`hospitalization_no`, `room_name`, `regi_no`, `hospitalization_content`, `state`, `create_date`, `discharge_date`) VALUES
	...
	(2, 'A02', 11, '다리 관절 이상으로 입원중 입니다.\n [2024-05-17 14:06 박임시] 테스트\n [2024-05-21 10:35 박임시] 퇴원시키겠습니당 ', '퇴원', '2024-05-17 11:37:31', '2024-05-20 11:37:31'),
	(3, 'C03', 12, '다리 골절 수술로 입원\n [2024-05-21 10:57 박임시] 골절수술 부위 체크완료 ', '입원', '2024-05-14 10:47:00', '2024-05-16 00:00:00'),
	...
	(16, 'A01', 5, '다리 수술 후 입원 중 입니다.  \r\n\n [2024-05-23 21:02 박임시] 다리 경과 좋음 ', '입원', '2024-05-17 12:09:33', '2024-05-20 12:09:33');
...
-- 테이블 데이터 atti.password_history:~2 rows (대략적) 내보내기
...
INSERT INTO `password_history` (`history_no`, `emp_no`, `previous_pw`, `update_date`) VALUES
	...
	(8, 1100802, '*00A51F3F48415C7D4E8908980D443C29C69B60C9', '2024-05-29 16:54:02');
...
-- 테이블 데이터 atti.payment:~75 rows (대략적) 내보내기
DELETE FROM `payment`;
INSERT INTO `payment` (`payment_no`, `regi_no`, `payment_state`, `payment_category`, `create_date`) VALUES
	...
	(23, 15, '미납', '진료', '2024-05-28 17:44:43'),
	(24, 15, '미납', '검사', '2024-05-14 10:47:00'),
	(25, 15, '미납', '입원', '2024-05-28 17:47:21'),
	(26, 15, '미납', '수술', '2024-05-28 17:44:29'),
	(27, 15, '미납', '처방', '2024-05-28 16:20:34'),
	...
	(70, 2, '완납', '진료', '2024-03-24 14:02:19'),
	(84, 45, '미납', '진료', '2024-05-30 16:04:59'),
	(85, 46, '미납', '진료', '2024-05-30 14:45:50'),
	(86, 45, '미납', '검사', '2024-05-30 10:47:25'),
	(87, 45, '미납', '수술', '2024-05-30 10:47:36'),
	(88, 45, '미납', '처방', '2024-05-30 10:48:51');
...
-- 테이블 데이터 atti.pet:~18 rows (대략적) 내보내기
DELETE FROM `pet`;
...
-- 테이블 데이터 atti.prescription:~12 rows (대략적) 내보내기
...
INSERT INTO `prescription` (`prescription_no`, `regi_no`, `medicine_no`, `prescription_content`, `prescription_date`) VALUES
	...
	(5, 15, 1, '수술 후 소염제 ', '2024-05-28 16:20:30'),
	...
	(31, 45, 1, 'fff', '2024-05-30 10:48:51');
...
-- 테이블 데이터 atti.registration:~32 rows (대략적) 내보내기
DELETE FROM `registration`;
INSERT INTO `registration` (`regi_no`, `pet_no`, `emp_no`, `regi_content`, `create_date`, `regi_state`, `regi_date`) VALUES
	(2, 1, 1100802, '배변기능 이상', '2024-05-09 16:59:37', '대기', '2024-05-14 13:47:00'),
	(3, 2, 2020226, '다리 관절  이상', '2024-05-09 16:59:37', '대기', '2024-05-14 14:47:00'),
	(4, 3, 3200513, '시력  이상', '2024-05-09 16:59:37', '예약', '2024-05-24 10:00:00'),
	(5, 4, 3181112, '소화 기능  이상', '2024-05-09 16:59:37', '대기', '2024-05-14 15:47:00'),
	(6, 5, 1100802, '배변기능 이상', '2024-05-14 10:47:00', '대기', '2024-05-14 16:47:00'),
	(7, 6, 2020226, '다리 관절  이상', '2024-05-14 10:47:00', '대기', '2024-05-25 10:10:10'),
	(8, 7, 3200513, '시력  이상', '2024-05-14 10:47:00', '예약', '2024-05-20 11:11:11'),
	(9, 8, 3181112, '소화 기능  이상', '2024-05-14 10:47:00', '예약', '2024-05-26 09:00:00'),
	(10, 5, 2020226, '소화 기능 이상', '2024-05-14 10:47:00', '진행', '2024-05-14 07:47:00'),
	(11, 6, 1100802, '다리 관절  이상', '2024-05-14 10:47:00', '진행', '2024-05-14 08:47:00'),
	(12, 7, 2020227, '다리 관절 골절', '2024-05-14 10:47:00', '진행', '2024-05-14 09:47:00'),
	(13, 8, 1100802, '비틀비틀 걸어요', '2024-05-14 10:47:00', '진행', '2024-05-14 10:47:00'),
	(14, 9, 2020226, '눈에 이물질이 들어갔어요', '2024-05-14 10:47:00', '진행', '2024-05-14 11:47:00'),
	(15, 10, 1100802, '발작증상', '2024-05-14 10:47:00', '진행', '2024-05-14 12:47:00'),
	(16, 11, 1100802, '시력  이상', '2024-05-09 16:59:37', '완료', '2024-05-09 10:59:37'),
	(17, 12, 1100802, '다리 관절  이상', '2024-05-09 16:59:37', '완료', '2024-05-09 11:59:37'),
	(18, 13, 2020226, '토했어요', '2024-05-09 16:59:37', '완료', '2024-05-09 12:59:37'),
	(19, 14, 2020227, '발톱 자르러 왔어요', '2024-05-09 16:59:37', '완료', '2024-05-09 13:59:37'),
	(20, 15, 1100802, '중성화수술', '2024-05-09 16:59:37', '완료', '2024-05-09 14:59:37'),
	(21, 12, 1100802, '수술 후 경과', '2024-05-11 16:59:37', '완료', '2024-05-11 10:59:37'),
	(22, 13, 2020226, '계속 토해요(재진료)', '2024-05-11 16:59:37', '완료', '2024-05-11 11:59:37'),
	(23, 15, 1100802, '중성화 수술 후 재진료', '2024-05-11 16:59:37', '완료', '2024-05-11 12:59:37'),
	(24, 11, 1100802, '퇴원 후 경과 확인', '2024-05-11 16:59:37', '완료', '2024-05-11 13:59:37'),
	(25, 14, 2020227, '부리에 금갔어요', '2024-05-11 16:59:37', '완료', '2024-05-11 14:59:37'),
	(26, 11, 1100802, '시력  이상', '2024-04-02 16:59:37', '완료', '2024-04-02 15:59:37'),
	(27, 12, 1100802, '다리 관절  이상', '2024-04-08 16:59:37', '완료', '2024-04-08 12:59:37'),
	(28, 13, 2020226, '토했어요', '2024-04-08 16:59:37', '완료', '2024-04-08 16:59:37'),
	(29, 14, 2020227, '발톱 자르러 왔어요', '2024-04-06 16:59:37', '완료', '2024-04-06 16:59:37'),
	(30, 15, 1100802, '중성화수술', '2024-04-05 16:59:37', '완료', '2024-04-05 16:59:37'),
	(45, 20, 1100802, 'ww', '2024-05-30 08:49:00', '진행', '2024-05-30 09:00:00'),
	(46, 20, 1100802, '예약test', '2024-05-30 10:45:04', '진행', '2024-05-30 09:00:00'),
	(47, 20, 1100802, 'ㅈㄷㄹ', '2024-05-30 16:09:52', '대기', '2024-05-30 11:00:00');
...
CREATE TABLE IF NOT EXISTS `surgery` (
  ...
  `surgery_state` enum('대기','완료') DEFAULT NULL,
...
-- 테이블 데이터 atti.surgery:~9 rows (대략적) 내보내기
DELETE FROM `surgery`;
INSERT INTO `surgery` (`surgery_no`, `regi_no`, `surgery_kind`, `surgery_content`, `surgery_date`, `surgery_state`) VALUES
	(2, 12, '외과', '골절로 인한 수술 진행 ', '2024-05-14 09:47:00', '대기'),
	(3, 15, '외과', '종양 발견 발견으로 수술 진행', '2024-05-14 12:47:00', '완료'),
	(4, 17, '외과', '골절로 인한 수술 진행 ', '2024-05-09 11:59:37', '대기'),
	(5, 20, '외과', '중성화수술', '2024-05-09 14:59:37', '대기'),
	(6, 22, '내과', '소화기관 수술', '2024-05-11 11:59:37', '대기'),
	(7, 25, '외과', '부리 접합 수술', '2024-05-11 14:59:37', '대기'),
	(8, 27, '외과', '골절로 인한 수술 진행 ', '2024-04-08 12:59:37', '대기'),
	(9, 30, '외과', '중성화수술', '2024-04-05 16:59:37', '대기'),
	(14, 45, '내과', 'ff', '2024-05-30 10:47:00', NULL);
