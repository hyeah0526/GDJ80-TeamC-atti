...
public class HospitalRoomDao {
	...
	*/
	...
	/*
	 * 메소드: #hospitalizationDetail(int regNo) 
	 * 페이지: hospitalizationDetail.jsp
	 * 시작 날짜: 2024-05-13
	 * 담당자: 박혜아
	*/
	public static ArrayList<HashMap<String, Object>> hospitalizationDetail(int regNo) throws Exception{
		ArrayList<HashMap<String, Object>> list = new ArrayList<HashMap<String,Object>>();
		
		System.out.println("HospitalRoomDao #hospitalizationDetail() 접수번호 확인--> " + regNo);
		...
		String sql = "SELECT regi.regi_no regiNo, h.hospitalization_no hospitalNo, h.room_name roomName,"
				+ " h.hospitalization_content hospitalContent, h.create_date createDate, h.discharge_date dischargeDate , e.emp_name empName,"
